...
export const LearnHero = () => {
    ...
    const [selectedOption, setSelectedOption] = useState("AI Academy");
    const dropdownRef = useRef(null);

    const dropdownOptions = [
        { label: "AI Agents", path: "/" },
        { label: "AI Academy", path: "/learn" },
        ...
        <Container component="main" className={`${classes.main}`} maxWidth={false} disableGutters>
            <div className={classes.contentWrapper}>
                ...
                <div className={classes.buttonContainer}>
                    <button className={classes.primaryButton} onClick={handleStartLearning}>
            ...
            <div className={classes.imageWrapper}>
                <img 
                    src="/poisson_ts.webp" 
                    alt="EggOn AI Academy Interface" 
